...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const hydrateRealtimeToken = async () => {
    try {
      ...
      if (realtime?.token) localStorage_service.saveAuthToken(realtime.token);
    } catch {
  ...
  return (
    <AuthContext.Provider value={{ user, isAuthenticated, isAuthReady, isAdmin, updateUser, login, loginWithGoogle, register, hasPermission, logout, setUser }}>
      {children}
